 ...
 * To trigger a route transition, use the `Link` component from `@payloadcms-local/ui`,
 ...
 * @example
 * import { RouteTransitionProvider, ProgressBar, Link } from '@payloadcms-local/ui'
 * const App = () => (
 ...
 * import { useTransition } from '@payloadcms-local/ui'
