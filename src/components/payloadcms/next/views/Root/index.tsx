...
import { PageConfigProvider } from '@/components/payloadcms/ui/exports/client'
...
import { MinimalTemplate } from '../../templates/Minimal/index'
...
import { isCustomAdminView } from '../../utilities/isCustomAdminView'
import { isPublicAdminRoute } from '../../utilities/isPublicAdminRoute'
